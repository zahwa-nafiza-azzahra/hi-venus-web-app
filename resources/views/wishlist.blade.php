    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter mb-section-gap">
        ...
        <div class="bg-surface-container-lowest border-4 border-on-background shadow-[8px_8px_0px_0px_rgba(27,28,28,1)] p-6 relative group hover:-translate-y-1 hover:translate-x-1 hover:shadow-[4px_4px_0px_0px_rgba(27,28,28,1)] transition-all animate-scale-in">
            <div class="aspect-square bg-tertiary-fixed border-4 border-on-background mb-4 overflow-hidden relative">
                <img class="w-full h-full object-cover -rotate-3 group-hover:rotate-0 transition-transform duration-300" src="{{ $p->image ? asset('storage/' . $p->image) : 'https://lh3.googleusercontent.com/aida-public/AB6AXuC7hQjMKr-I4FiKO77l686kTHlpVcH8GQGJMApwkJc5f7bS8CVt3xu4ljvs55Aac3uJMbXQtM9PFEQdzsdzGahpu9LyYuowv745FNFLthLAMITi7VSPz7Dshmst7kJjpnUvPAktI9cCOKX6kb8cN6INxLBVbXKFQEP9zrpothTQaSA3D_aCQtixtdaozNG5GSUrQwkVsly4DGGPWTgJcYOX3cKBqt0HOTN19awWewwuoPwOPjcH0JKoqoyOSKym0u9OHnhleKG73wmx' }}" alt="{{ $p->name }}">
