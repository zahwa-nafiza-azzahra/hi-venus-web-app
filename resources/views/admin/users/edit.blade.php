...
@section('title','Edit User - Hi Venus')
...
<div class="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm max-w-3xl">
    <div class="px-8 py-6 border-b border-outline-variant/10">
        <h3 class="font-black text-on-primary-fixed-variant">Edit User</h3>
        <p class="text-xs text-on-surface-variant mt-1">{{ $user->email }}</p>
    </div>
    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-8 space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-2 md:col-span-1">
                <label class="block text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-2">New Password</label>
            ...
            <div class="col-span-2 md:col-span-1">
                <label class="block text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-2">Confirm</label>
