...
@section('title', 'Join Hi Venus | Create Account')
    ...
    <div class="relative w-full max-w-lg z-10">
        ...
        <div class="bg-surface-bright border-4 border-on-background rounded-xl p-8 relative flex flex-col gap-8 shadow-[12px_12px_0px_0px_rgba(27,28,28,1)]">
            ...
            <div class="flex gap-4 p-2 bg-surface-container-highest border-4 border-on-background rounded-lg">
                <a href="{{ route('login') }}" class="flex-1 font-label-bold text-label-bold text-on-surface hover:bg-surface-variant rounded p-3 transition-colors text-center block">
                    Log In
                </a>
            ...
            <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-2">
                    <label class="font-label-bold text-label-bold text-on-background flex items-center gap-2">
                        <span class="material-symbols-outlined text-primary text-xl" style="font-variation-settings: 'FILL' 1;">badge</span>
                        Full Name
                    </label>
                    <input name="name" class="w-full bg-surface-bright px-4 py-4 border-4 border-on-background rounded-lg font-body-md text-body-md focus:outline-none focus:border-tertiary-container focus:ring-0 shadow-[inset_0px_6px_0px_0px_rgba(27,28,28,0.08)] transition-colors placeholder:text-outline" placeholder="Cute Bunny" type="text" value="{{ old('name') }}" required autofocus/>
                    @error('name')
